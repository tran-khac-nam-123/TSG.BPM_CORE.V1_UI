...
export default class AddUser extends Component {
  ...
  async handleAdd() {
    const listName = "ListMapEmployee";
    const item = {
      Title: this.state.Title ? this.state.Title : "",
      ApproveCode: this.state.ApproveCode ? this.state.ApproveCode : "",
      DeptCode: this.state.DeptCode ? this.state.DeptCode : "",
      RoleCode: this.state.RoleCode ? this.state.RoleCode : "",
      UserId: this.state.list_UserDefault[0].UserId,
    };
  ...
  render() {
    const { list_UserDefault } = this.state;
    return (
      <Fragment>
        <Container>
          <Row>
              ...
              <Card>
                <div className="modal-header">
                  ...
                  <button
                    ...
                    data-dismiss="modal"
                    aria-label="Close"
                    onClick={() => this.props.toggleAddUser(false)}
                  >
